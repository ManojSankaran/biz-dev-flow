...
import { ChevronDown, ChevronRight, AlertTriangle, ArrowUp, ArrowDown, Minus, Play, Trash2 } from "lucide-react";
...
export function RequirementCard({ requirement, onStatusChange, onAutoProgress, onDelete }: Props) {
