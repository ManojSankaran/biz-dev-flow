...
import { Requirement, AgentStatus, APPROVAL_AGENTS } from "@/types/requirement";
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          <div className="hidden sm:flex items-center gap-3">
            <div className="relative h-8 w-8">
              <svg className="h-8 w-8 -rotate-90" viewBox="0 0 32 32">
                ...
                <circle cx="16" cy="16" r="12" fill="none" className="stroke-primary transition-all duration-500" strokeWidth="3" strokeDasharray={`${progress * 0.754} 100`} strokeLinecap="round" />
              </svg>
          ...
          <span className="text-xs text-muted-foreground font-mono hidden md:block">{requirement.createdAt}</span>
        </div>
      </button>
